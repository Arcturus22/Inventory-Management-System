...
namespace IMS.UseCases.PluginInterfaces
{
    ...
    {
        Task<IEnumerable<ProductTransaction>> GetProductTransactionAsync(string prodName, DateTime? dateFrom, DateTime? dateTo, ProductTransactionType? transactionType);
